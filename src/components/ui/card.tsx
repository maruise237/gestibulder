...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'group/card bg-card text-card-foreground ring-foreground/10 flex flex-col overflow-hidden rounded-xl text-sm ring-1',
        padding === 'default' && 'gap-4 py-4',
        padding === 'none' && 'p-0',
        hoverable && 'hover:ring-foreground/20 cursor-pointer transition-all hover:shadow-md',
